...
LLM agents can bootstrap this setup for you — install the agent skills with `linear-agent skills install` and the [linear-agent-cli skill](skills/linear-agent-cli.md) includes first-time setup instructions.
