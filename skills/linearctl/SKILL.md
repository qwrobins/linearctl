...
- `linearctl project list [--team <id>] [--state <name>] [--all-teams] --json` — includes portfolio fields (`progress`, `health`, `currentProgress`) and normalized `milestones` in JSON output
