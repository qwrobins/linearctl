...
export const COMMAND_REGISTRY: readonly CommandRegistration[] = [
  // ── Issue ──────────────────────────────────────────────────────────────
  {
    ...
    optionKeys: [
      ...
      "cycle", "project", "order-by", "order-dir", "parent",
    ],
    subcommands: {
      get:            { usage: "linearctl issue get <identifier> [--json]" },
      create:         { usage: "linearctl issue create --title <title> --team <id> [--description <text>] [--priority <0-4>] [--estimate <n>] [--assignee <id>] [--label <id>] [--state <id>] [--cycle <id>] [--project <id>] [--parent <id>] [--json]" },
      ...
      update:         { usage: "linearctl issue update <identifier> [--title <text>] [--description <text>] [--priority <0-4>] [--estimate <n>] [--assignee <id>] [--label <name|id>] [--state <id>] [--cycle <id>] [--project <id>] [--parent <id>] [--json]" },
    ...
    buildOptions: (args, env) => ({
      ...
      ...pickFields(args, "title", "description", "priority", "estimate", "assignee",
        ...
        "cycle", "project", "orderBy", "orderDir", "parent"),
    }),
  },
