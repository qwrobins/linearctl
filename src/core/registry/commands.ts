...
export const COMMAND_REGISTRY: readonly CommandRegistration[] = [
  // ── Issue ──────────────────────────────────────────────────────────────
  {
    ...
    subcommands: {
      ...
      "bulk-update":  { usage: "linearctl issue bulk-update --ids <id1,id2,...> [--state <name|id>] [--assignee <id>] [--priority <0-4>] [--estimate <n>] [--label <id>] [--cycle <id>] [--project-milestone <id>|--milestone <id>] [--json]" },
