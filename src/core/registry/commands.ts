...
export const COMMAND_REGISTRY: readonly CommandRegistration[] = [
  // ── Issue ──────────────────────────────────────────────────────────────
  {
    ...
    optionKeys: [
      ...
      "title", "team", "description", "description-file", "priority", "estimate", "assignee",
      "label", "state", "status", "input-json", "ids", "body", "url", "sync", "query", "search",
    ...
    subcommands: {
      ...
      update:         { usage: "linearctl issue update <identifier> [--title <text>] [--description <text>|--description-file <path|->] [--priority <0-4>] [--estimate <n>] [--assignee <id>] [--label <name|id>] [--state <name|id>] [--cycle <id>] [--project <name|id>] [--parent <identifier>] [--json]" },
    ...
    buildOptions: (args, env, stdin) => ({
      ...
      sync: args.sync,
      stdinStream: stdin,
      ...pickFields(args, "title", "description", "descriptionFile", "priority", "estimate", "assignee",
        "label", "state", "states", "status", "inputJson", "ids", "body", "url", "query", "search",
  ...
  // ── Project ────────────────────────────────────────────────────────────
  {
    ...
    optionKeys: [
      ...CURATED_BASE,
      ...OPTION_GROUPS.allTeams,
      "name", "description", "description-file", "team", "state", "status", "query", "search", "lead", "start-date", "target-date", "issues-json",
    ],
    subcommands: {
      ...
      create:               { usage: "linearctl project create --name <name> [--description <text>|--description-file <path|->] [--team <id>] [--lead <user>] [--json]" },
      update:               { usage: "linearctl project update <id> [--name ...] [--description <text>|--description-file <path|->] [--status <name|type|id>|--state <name|type>] [--lead <user>] [--start-date <date>] [--target-date <date>] [--json]" },
    ...
    buildOptions: (args, env, stdin) => ({
      ...
      ...teamFilterOptions(args),
      stdinStream: stdin,
      ...pickFields(args, "name", "description", "descriptionFile", "state", "states", "status", "query", "search", "lead", "startDate", "targetDate", "issuesJson"),
    }),
  },
