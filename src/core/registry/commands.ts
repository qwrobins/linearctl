...
export const COMMAND_REGISTRY: readonly CommandRegistration[] = [
  ...
  // ── Project ────────────────────────────────────────────────────────────
  {
    ...
    optionKeys: [
      ...CURATED_BASE,
      ...OPTION_GROUPS.allTeams,
      "name", "description", "team", "state", "status", "query", "search", "lead", "start-date", "target-date", "issues-json",
    ],
    subcommands: {
      ...
      create:               { usage: "linearctl project create --name <name> [--description ...] [--team <id>] [--lead <user>] [--json]" },
    ...
    buildOptions: (args, env) => ({
      ...
      ...paginationOptions(args),
      ...teamFilterOptions(args),
      ...pickFields(args, "name", "description", "state", "states", "status", "query", "search", "lead", "startDate", "targetDate", "issuesJson"),
    }),
  },
