...
export const COMMAND_REGISTRY: readonly CommandRegistration[] = [
  // ── Issue ──────────────────────────────────────────────────────────────
  {
    ...
    subcommands: {
      ...
      update:         { usage: "linearctl issue update <identifier> [--title <text>] [--description <text>] [--priority <0-4>] [--estimate <n>] [--assignee <id>] [--state <id>] [--cycle <id>] [--json]" },
  ...
  // ── Project ────────────────────────────────────────────────────────────
  {
    ...
    subcommands: {
      ...
      update:               { usage: "linearctl project update <id> [--name ...] [--state ...] [--target-date <date>] [--json]" },
